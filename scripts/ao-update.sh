...
if [ "$SMOKE_ONLY" = false ]; then
  ...
  run_cmd pnpm --filter @agentboard/ao-core clean
  run_cmd pnpm --filter @agentboard/ao-cli clean
  run_cmd pnpm --filter @agentboard/ao-web clean

  run_cmd pnpm --filter @agentboard/ao-core build
  run_cmd pnpm --filter @agentboard/ao-cli build
  run_cmd pnpm --filter @agentboard/ao-web build
