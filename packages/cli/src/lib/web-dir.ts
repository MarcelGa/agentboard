/**
 * Web directory locator — finds the @agentboard/ao-web package.
...
/**
 * Locate the @agentboard/ao-web package directory.
...
export function findWebDir(): string {
  ...
  try {
    const pkgJson = require.resolve("@agentboard/ao-web/package.json");
    ...
    throw new Error(
      "Could not find @agentboard/ao-web package.\n" +
      "  If installed via npm:    npm install -g @agentboard/ao\n" +
